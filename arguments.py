...
def add_data_args(parser: argparse.ArgumentParser):
    ...
    group.add_argument('--train_split_ratio', type=float, default=0.8, help="Ratio of train split for training. The rest will be used for validation.")
    return parser
...
def add_peft_args(parser: argparse.ArgumentParser):
    ...
    group.add_argument("--peft-lora-dropout", type=float, default=0.05)
