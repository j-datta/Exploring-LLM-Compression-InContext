...
class Encoder(object): 
    ...
    def encode(self, line):
        ...
        decoded_prompt = Encoder.tokenizer.decode(prompt_tokens)
        ...
        response_tokens = Encoder.tokenizer.encode(f" {output}", add_special_tokens=False) + [Encoder.tokenizer.eos_token_id]
