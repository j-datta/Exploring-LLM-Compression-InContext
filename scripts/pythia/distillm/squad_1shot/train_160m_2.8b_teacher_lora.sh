...
PEFT_CKPT_NAME="pythia-160m/39063"
PEFT_CKPT="${BASE_PATH}/results/pythia/train/minillm_init/squad_1shot/sft_160m_lora/${PEFT_CKPT_NAME}/"
...
MAX_LENGTH=1800
# runtime
SAVE_PATH="${BASE_PATH}/results/pythia/train/distillm/squad_1shot/160m_2.8b"
# seed
SEED=10
