...
PEFT_CKPT_NAME="pythia-1b/39063"
PEFT_CKPT="${BASE_PATH}/results/pythia/train/minillm_init/squad_1shot/sft_1b_lora/${PEFT_CKPT_NAME}/"
...
MAX_LENGTH=1800
# runtime
SAVE_PATH="${BASE_PATH}/results/pythia/train/distillm/squad_1shot/1b_2.8b"
# seed
SEED=10
