...
PEFT_CKPT_NAME="pythia-70m/1719"
PEFT_CKPT="${BASE_PATH}/results/pythia/train/minillm_init/mlqa_en_1shot/sft_70m_lora/${PEFT_CKPT_NAME}/"
...
MAX_LENGTH=2048
# runtime
SAVE_PATH="${BASE_PATH}/results/pythia/train/distillm/mlqa_en_1shot/70m_2.8b"
# seed
SEED=10
