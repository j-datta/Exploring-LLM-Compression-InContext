...
PEFT_CKPT_NAME="pythia-1b/1719"
PEFT_CKPT="${BASE_PATH}/results/pythia/train/minillm_init/mlqa_en_1shot/sft_1b_lora/${PEFT_CKPT_NAME}/"
...
MAX_LENGTH=2048
# runtime
SAVE_PATH="${BASE_PATH}/results/pythia/train/distillm/mlqa_en_1shot/1b_2.8b"
# seed
SEED=10
