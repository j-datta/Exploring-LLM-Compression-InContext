...
PEFT_CKPT_NAME="pythia-1.4b/1719"
PEFT_CKPT="${BASE_PATH}/results/pythia/train/minillm_init/mlqa_en_1shot/sft_1.4b_lora/${PEFT_CKPT_NAME}/"
TEACHER_CKPT="EleutherAI/pythia-2.8b"
TEACHER_PEFT_CKPT_NAME="pythia-2.8b/11460"
TEACHER_PEFT_CKPT="${BASE_PATH}/results/pythia/train/sft/sft_mlqa_en_1shot/sft_2.8b_lora/${TEACHER_PEFT_CKPT_NAME}/"
# data
...
MAX_LENGTH=2048
# runtime
/home/IAIS/jdatta/distillm-new/results/pythia/train/distillm/mlqa_en_1shot
SAVE_PATH="${BASE_PATH}/results/pythia/train/distillm/mlqa_en_1shot/1.4b_2.8b"
# seed
SEED=10
