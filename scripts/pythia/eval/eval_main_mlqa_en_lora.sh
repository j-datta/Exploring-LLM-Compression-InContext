...
PEFT_CKPT_NAME=${5-"70m_2.8b/11460"}
PEFT_CKPT="${BASE_PATH}/results/pythia/train/distillm/mlqa_en_1shot/${PEFT_CKPT_NAME}/"
# data
DATA_NAMES="mlqa"
DATA_DIR="${BASE_PATH}/data/mlqa_1shot/english/"
#DATA_DIR="${BASE_PATH}/processed_data_pythia70M/squad_v2/prompt/pythia/"
# hp
EVAL_BATCH_SIZE=8
# runtime
SAVE_PATH="${BASE_PATH}/results/pythia/eval/eval_distill_mlqa_en_1shot/eval_main_70m_2.8b"
TYPE="eval_main"
