...
PEFT_CKPT_NAME=${5-"pythia-2.8b/2250"}
PEFT_CKPT="${BASE_PATH}/results/pythia/train/sft/sft_2.8b_mlqa_de/${PEFT_CKPT_NAME}/"
# data
DATA_NAMES="mlqa"
DATA_DIR="${BASE_PATH}/data/mlqa/deutsch/"
#DATA_DIR="${BASE_PATH}/processed_data_pythia70M/squad_v2/prompt/pythia/"
# hp
EVAL_BATCH_SIZE=16
# runtime
SAVE_PATH="${BASE_PATH}/results/pythia/eval/eval_sft_mlqa_de/eval_main_sft_2.8b"
TYPE="eval_main"
