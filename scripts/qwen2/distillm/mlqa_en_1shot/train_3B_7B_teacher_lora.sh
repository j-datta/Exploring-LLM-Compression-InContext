...
PEFT_CKPT_NAME="Qwen2.5-3B/6891"
PEFT_CKPT="${BASE_PATH}/results/qwen2.5/train/minillm_init/mlqa_en_1shot/sft_3B_lora/${PEFT_CKPT_NAME}/"
...
MAX_LENGTH=3096
# runtime
SAVE_PATH="${BASE_PATH}/results/qwen2.5/train/distillm/mlqa_en_1shot/3B_7B"
# seed
SEED=10
