...
# data
DATA_DIR="${BASE_PATH}/processed_data_test/squad_1shot/full/qwen/"
# hp
BATCH_SIZE=2
...
MAX_LENGTH=2300
# runtime
SAVE_PATH="${BASE_PATH}/results/qwen2.5/train/minillm_init/squadv2_1shot/sft_1.5B_lora"
# seed
SEED=20
SEED_ORDER=10
