...
PEFT_CKPT_NAME=${5-"0.5B_7B/17660"}
PEFT_CKPT="${BASE_PATH}/results/qwen2.5/train/distillm/mlqa_de_1shot/${PEFT_CKPT_NAME}/"
# data
DATA_NAMES="mlqa"
DATA_DIR="${BASE_PATH}/data/mlqa_1shot_qwen2/deutsch/"
#DATA_DIR="${BASE_PATH}/processed_data_pythia70M/squad_v2/prompt/pythia/"
# hp
EVAL_BATCH_SIZE=16
# runtime
SAVE_PATH="${BASE_PATH}/results/qwen2.5/eval/eval_distill_mlqa_de_1shot/eval_main_0.5B_7B"
TYPE="eval_main"
